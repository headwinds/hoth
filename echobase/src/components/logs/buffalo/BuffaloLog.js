				...
				<div className={styles.log}>
					<article className={styles.log_article}> 
						...
						<div className={styles.log_content}>
							<p>There are&nbsp;more than 30 different sites that offer code playgrounds where you can play with HTML, CSS, and Javascript and see the results. As of today, <a href="http://codepen.io/headwinds/">Codepen</a> is the only worth pursuing if you are hybrid designer/developer who needs to prototype a shallow app experience.</p>
							<p>If I was giving out medals for code playgrounds capable of building complex components, I’d give out two silvers to and <a href="http://plnkr.co/users/headwinds">Plunker</a>, and a bronze to <a href="https://jsfiddle.net/user/headwinds/">jsfiddle</a>. I believe gold is still up for grabs.  </p>
							<p>For the longest time, I preferred to do my tinkering in <a href="http://jsfiddle.net/user/headwinds/fiddles/">jsfiddle</a> since it felt more flexible until last month when I started experimenting with Angular2 and playing with their example plunks. </p>
							<p>Plunker strength is its ability to create multiple files and begin simulate the complex file structure which one would encounter in a large app. It beats Codepen on this file system front, and beyond that, it's a mess and lacks a lot of the community features, pen organization, and overall polish within Codepen. </p>
							<p><img src={codepen} /></p>
							<p>I've attempted two Angular 2 protypes in Codepen and Plunker. In this <a href="http://codepen.io/headwinds/pen/JXOqye">pen</a>, I built a simple shopping cart after forking another sample that did a lot of event work but lacked multiple store support and the actual UI to make purchases.</p> 
							<p><img src={buffaloPlunker} /></p>
							<p>In this <a href="http://plnkr.co/edit/rXSepV1PpxaHNfBdwUEW">plunk</a>, I wanted to experiment with Observerables, a concept new to angular 2. Unlike promises, Oberservrables can emit multiple values over time and manage unidirectional data flow as described in this nice post, <a href="https://coryrylan.com/blog/angular-2-observable-data-services">Angular 2 Observable Data Services</a>. </p>
							...
							<p>When Codepen implements a file system, it will more truly mirror how we prototype modular apps; marking an end to hours wasted configuring and a quick start jumping right into the flow</p>
						</div>
					</article>
				</div>
		</div>

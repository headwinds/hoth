...
class Trioova extends Component {

  componentDidMount() {
    console.log('Trioova componentDidMount ');
    ...
    return (
      <div className="bio" style={{ height: 620, background: "white", padding: 10, pointerEvents: "all" }}>
        <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
          <div>
          <h1 style={{ margin: 0, marginBottom: 10 }}>Trioova Marketplace</h1>
          </div>
          <div>
        ...
        {' '} as a Frontend Architect. I enjoy prototyping, interaction design, data visualization, and leading a frontend team.

        </p>
          <p>
            Previously, I had an amazing 5 years working at     <a
                  href="https://www.trioova.ca/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={paralinkStyle}
                >
            ...
            I  worked on a file sharing application with
            group chat that allowed health care providers
            to form a care team and discuss issues in a secure space.
          </p>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Trioova);
